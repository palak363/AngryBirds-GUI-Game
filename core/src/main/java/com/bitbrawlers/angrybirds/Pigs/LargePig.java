...
public class LargePig extends Pig implements Serializable {
    private transient Texture pigTexture;
    private Vector2 position;  // Use Vector2 for position

    public LargePig(int health, float x, float y) {
        super(health, 3, x, y);  // Pass x and y to the superclass
        this.pigTexture = new Texture("Elements/Pigs/largePig.png");
    ...
    // Method to set the position of the LargePig
