...
public class Level1 implements Screen, Serializable {
    ...
    @Override
    public void show() {// Load the game state when the screen is shown
        //loadGameState1();
    }
    ...
    public void reinitialize(AngryBirds game) {
        ...
        // Reinitialize camera, textures, sounds, and spriteBatch
        camera = new OrthographicCamera();
    ...
    public void restoreDynamicState() {
        ...
        redBird2.setPosition(new Vector2(1.7F, 1.25F));
        redBird3.setPosition(new Vector2(0.7F, 1.25F));
