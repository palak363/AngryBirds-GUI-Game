...
public class Level2 implements Screen, Serializable {
    private static final String LEVEL2 = "level1_state.ser";
    float GROUND = 1.3F;
    Vector2 touchPos;
    private transient OrthographicCamera camera;
    public RedBird redBird;
    public YellowBird yellowBird;
    public BlackBird blackBird;
    public int win =0;
    public SmallPig smallPig1;
    public SmallPig largePig1;
    public SmallPig largePig2;
    ...
    public transient AngryBirds game;
    ...
    public boolean isBirdLaunched = false;
    ...
    public boolean checkCollisionWithBlock(Bird bird, Block block) {
        ...
        return birdX < blockX + blockWidth && birdX + birdWidth > blockX && birdY < blockY + blockHeight && birdY + birdHeight > blockY;
    }
