...
public class GreenBird extends Bird implements Serializable {
    ...
    public GreenBird(float x, float y) {
        super("Green", 2);
        this.birdTexture = new Texture("Elements/Birds/greenBird.png");  // Load bird image
